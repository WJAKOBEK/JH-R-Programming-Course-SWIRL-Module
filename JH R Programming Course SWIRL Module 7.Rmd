...
Error in matrix(data = 1:20, nrow = 4, ncol = 5, byrow = false, dimnames = NULL) : 
...
| Make sure to capitalize the first letter of each name and to store the result in a variable called patients. Also,
| don't get the order of the patients mixed up! That would be a disaster!
...
> cnames <- ("age", "weight", "bp", "rating", "test")
Error: unexpected ',' in "cnames <- ("age","
> 
> > cnames <- c("age", "weight", "bp", "rating", "test")
Error: unexpected '>' in ">"
> cnames <- c("age", "weight", "bp", "rating", "test")
...
| data frames. There's much more to learn and we'll be covering more advanced topics, particularly with respect to
